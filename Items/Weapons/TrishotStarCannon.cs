...
{
	public class TrishotStarCannon : ModItem
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Tri-Shot Star Cannon");
		...
		{
			Recipe recipe = Recipe.Create(ModContent.ItemType<TrishotStarCannon>());
			recipe.AddIngredient(ItemID.StarCannon, 3);
			recipe.AddIngredient(ModContent.ItemType<TrishotPistol>(), 1);
