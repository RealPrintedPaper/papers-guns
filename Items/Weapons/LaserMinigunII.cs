...
{
	public class LaserMinigunII : ModItem
	{
        public override void SetStaticDefaults()
        {
			// DisplayName.SetDefault("Laser Minigun II");
		...
		{
			Recipe recipe = Recipe.Create(ModContent.ItemType<LaserMinigunII>());
			recipe.AddIngredient(ItemID.HallowedBar, 5);
			recipe.AddIngredient(ModContent.ItemType<ForbiddenGunParts>());
			recipe.AddIngredient(ModContent.ItemType<LaserMinigun>(), 1);
