...
{
	public class LargePlatinum : ModProjectile
	{
        ...
        {
			Projectile.NewProjectile(source, Projectile.Center, new Vector2(5, 5).RotatedByRandom(MathHelper.ToRadians(360)), ProjectileID.PlatinumCoin, Projectile.damage / 20, 0, Main.myPlayer);
		}
		...
		public override void OnKill(int timeLeft)
		{
			for (int i = 0; i < Main.rand.NextFloat(15, 25); i++)
			{
				...
				Projectile.NewProjectile(source, Projectile.Center, vel, ProjectileID.PlatinumCoin, Projectile.damage / 20, Projectile.knockBack, Projectile.owner, 0f, 0f);
			}
