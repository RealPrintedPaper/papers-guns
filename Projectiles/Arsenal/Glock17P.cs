...
{
	public class Glock17P : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (spawnin == true)
			{
				CombatText.NewText(Main.player[Projectile.owner].getRect(), Color.Red, "GLOCK 17!", false, false);
				spawnin = false;
			}
		...
		public override void OnKill(int timeLeft)
		{
			...
			Gore.NewGore(source, new Vector2(Projectile.position.X + (float)(Projectile.width / 2) - 24f, Projectile.position.Y + (float)(Projectile.height / 2) - 24f), new Vector2(Main.rand.NextFloat(-2, 2), Main.rand.NextFloat(-5, -2)), ModContent.GoreType<Gores.Glock17Gore>(), 1f);
		}
	}
}